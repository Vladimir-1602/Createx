(() => {
    ...
    function initSliders() {
        if (document.querySelector(".main-page__slider")) new core(".main-page__slider", {
            ...
            on: {
                init: function(swiper) {
                    swiper.realIndex;
                    const slidesLenght = document.querySelectorAll(".main-page__slide").length;
                    const numbersList = document.querySelector(".pagination-main__numbers");
                    let length = 0;
                    let id = 0;
                    do {
                        if (numbersList.children) {
                            length++;
                            let insert = () => `<div data-id="${id}" class="pagination-main__number">0${length}</div>`;
                            numbersList.insertAdjacentHTML("beforeend", insert());
                            id++;
                        }
                    } while (length < slidesLenght);
                    document.querySelector(".pagination-main__number").classList.add("active");
                },
                slideChange: function(swiper) {
                    let index = swiper.realIndex;
                    let numbers = document.querySelectorAll(".pagination-main__number");
                    numbers.forEach((item => {
                        item.dataset.id == `${index}` ? item.classList.add("active") : item.classList.remove("active");
                    }));
                }
            }
        });
        if (document.querySelector(".projects-page__slider")) new core(".projects-page__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
            ...
            simulateTouch: false,
            navigation: {
                prevEl: ".projects-page__prev",
                nextEl: ".projects-page__next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".saying__slider")) new core(".saying__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".projects-page__slider")) new core(".projects-page__slider", {
            ...
            simulateTouch: false,
            navigation: {
                prevEl: ".design-page__prev",
                nextEl: ".design-page__next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".modern__slider")) new core(".modern__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".main-modern__smallslider")) var smallSlider = new core(".main-modern__smallslider", {
            modules: [ Thumb ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
        ...
        if (document.querySelector(".main-modern__slider")) new core(".main-modern__slider", {
            ...
            navigation: {
                prevEl: ".main-modern__prev",
                nextEl: ".main-modern__next"
            },
            on: {}
        });
        if (document.querySelector(".tabs-about__slider")) new core(".tabs-about__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            simulateTouch: false,
            navigation: {
                prevEl: ".tabs-about__prev",
                nextEl: ".tabs-about__next"
            },
            on: {}
        });
    }
    ...
    document.addEventListener("click", (function(e) {
        let target = e.target;
        if (target.closest(".video-page__play")) {
            target.closest(".video-page__play").remove();
            let video = document.querySelector("video");
            video.setAttribute("controls", "");
            video.play();
        }
        if (target.closest(".bottom-footer__button")) {
            console.log(target);
            window.scrollTo(0, 0);
        }
    }));
    ...
    function windowLoad() {
        ...
        function digitsCountersAnimate(digitsCounter) {
            ...
            const parentItem = digitsCounter.parentElement;
            const step = timestamp => {
                if (!startTimestamp) startTimestamp = timestamp;
                const progress = Math.min((timestamp - startTimestamp) / duration, 1);
                digitsCounter.innerHTML = Math.floor(progress * (startPosition + startValue));
                const fullValue = parseInt(digitsCounter.dataset.digitsFull);
                const percent = startValue * 360 / fullValue;
                let time = Math.floor(percent * progress);
                let color1 = digitsCounter.dataset.color1;
                let color2 = digitsCounter.dataset.color2;
                parentItem.style.background = `conic-gradient(${color1} ${time}deg, ${color2} 0deg)`;
        ...
        let sections = document.querySelectorAll(".facts__items");
